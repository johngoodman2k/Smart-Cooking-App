                    ...
                    <div style="margin-top: 15%;padding-bottom: 10%; padding-top: 10%">
                        <div style="text-align: center;">
                            ...
                            <div style="margin-bottom: 10%;">
                                <input id="username" type="text" class="input" name="username" maxlength="50" autocomplete="new-password" placeholder="Tài khoản">
                            </div>
                            <div style="margin-bottom: 10%;">
                                <input id="password" type="password" class="input" data-type="password" name="password" maxlength="50" autocomplete="new-password" placeholder="Mật khẩu">
                            </div>
                            <div style="margin-bottom: 10%;">
                                <input id="confirm" type="password" class="input" data-type="password" name="confirm" autocomplete="off" maxlength="50" placeholder="Nhập lại mật khẩu">
                            </div>
                            <div style="margin-bottom: 10%;">
